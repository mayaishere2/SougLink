...
class _ProfileState extends State<Profile> {
  ...
  String location = 'الموقع غير محدد';
  String phoneNumber = '+213 000000000';
  ...
  final List<Map<String, dynamic>> PRF = [
    {'title': 'مستويات المخزون', 'image': 'assets/images/stock.png'},
    {'title': 'الردود على الطلبات', 'image': 'assets/images/response.png'},
    ...
    return GestureDetector(
      onTap: () {
        if (index == 3) {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) => MainPageSeller(activeIndex: index)));
        }
      },
      child: Container(
        height: 50,
        decoration: const BoxDecoration(
          border: Border(bottom: BorderSide(color: Color.fromARGB(255, 14, 78, 5), width: 2)),
        ),
        child: Padding(
          padding: const EdgeInsets.all(8),
          child: Row(
            children: [
              Image.asset(pic, width: 28, height: 28),
